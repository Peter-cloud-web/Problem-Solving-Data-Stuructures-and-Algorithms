 ...
 * If an interviewer asks you to solve 4Sum, they can follow-up with 5Sum, 6Sum, and so
 * on. What they are really expecting at this point is a kSum solution. Therefore, we will focus on a generalized implementation here.
 *
...
public class QuadpletsSum {
   ...
   public static void main(String[] args){
        ...
        QuadpletsSum qd = new QuadpletsSum();

       System.out.println(qd.fourSum(nums,target));

       System.out.println(qd.ksum(nums,target,start,k));

       System.out.println(qd.twoSum(nums,target,start));
